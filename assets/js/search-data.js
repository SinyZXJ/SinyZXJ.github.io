...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "Here you can find some of my repositories on GitHub.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Music",handler: () => {
              window.location.href = "/music/2021-faintfire/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.xiaohongshu.com/user/profile/598c7d7b50c4b44ab81d6472?xsec_token=YB1b8_pNH5PnjLC21YpCmK9fkRi32KPyx3jSTyBjZQTAg=&xsec_source=app_share&xhsshare=CopyLink&appuid=598c7d7b50c4b44ab81d6472&apptime=1744889014&share_id=7aab0805663843329d71ba2fa143e39e", "_blank");
        },
      },{
        id: 'social-netease_music',
        title: 'Netease_music',
        section: 'Socials',
        handler: () => {
          window.open("https://music.163.com/#/artist?id=46771775", "_blank");
        },
      },{
      id: 'light-theme',
